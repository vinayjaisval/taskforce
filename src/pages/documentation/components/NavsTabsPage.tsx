...
<Nav
	...
	return (
		<PageWrapper title={componentsMenu.manageAstrologer.subMenu.AddAstro.text}>
			<SubHeader>
				<SubHeaderLeft>
					<Breadcrumb
						list={[
							{
								title: componentsMenu.manageAstrologer.text,
								to: `/${componentsMenu.manageAstrologer.path}`,
							},
							{
								title: componentsMenu.manageAstrologer.subMenu.AddAstro.text,
								to: `/${componentsMenu.manageAstrologer.subMenu.AddAstro.path}`,
							},
						]}
					/>
				</SubHeaderLeft>
