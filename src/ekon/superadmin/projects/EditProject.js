...
const EditProject = () => {
	...
	async function onFormSubmit(e) {
		...
		if(lead.name == ''){
			...
			try {
			axios.put(`https://task.mycrmdesk.com/backend/api/admin/update-project/${id}`, lead)
			.then((res) => {
	...
	useEffect(() => {
		async function getDepartments() {
			try {
				const departmentApi = await axios.get(`https://task.mycrmdesk.com/backend/api/admin/edit-project/${id}`)
				setLead(departmentApi.data);


				// Assignee list
				try {
					const selAssApi = await axios.get(`https://task.mycrmdesk.com/backend/api/admin/get_sel_assignee_by_skills/${departmentApi.data.skills}`)
					setAssigneeList(selAssApi.data.data);
				} catch (error) {
					console.log("Something is Wrong -Sel Skills List");
				}
				...
				// Sel Assignee list
				try {
					const selAssApi = await axios.get(`https://task.mycrmdesk.com/backend/api/admin/get_sel_assignee/${departmentApi.data.assignee}`)
				...
				// Sel Skills list
				try {
					const selSkillApi = await axios.get(`https://task.mycrmdesk.com/backend/api/admin/get_sel_skills/${departmentApi.data.skills}`)
