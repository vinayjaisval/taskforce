...
const Projects = () => {
	...
	async function onFormSubmit(e) {
		...
		if (departmentName.name == '') {
			...
			try {
				axios.post(`${BASE_URL}/admin/add-project`, departmentName).then((res) => {
					console.log(res);
	...
	async function handleClick(e, delId) {
		axios.get(`${BASE_URL}/admin/project_delete/${delId}`).then((res) => {
			getPaginatedData(1);
										...
										<div className='col-12'>
											<FormGroup
												...
												<Input
													...
													name='start_date'
													id='start_date'
													value={departmentName.start_date}
													onChange={(e) => onTextFieldChange(e)}
												/>
											</FormGroup>
										</div>
										...
										<div className='col-md-12 col-xs-12'>
											<FormGroup
												...
												<select
													...
													onChange={(e) => onTextFieldChange(e)}
													required>
													<option value={departmentName.lead_by}>
														Select
													</option>
