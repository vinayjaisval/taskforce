...
const EditCanva = (props) => {
	...
	async function getDepartments() {
		try {
			const departmentApi = await axios.get(`https://task.mycrmdesk.com/backend/api/admin/edit-project/${userId}`)
	...
	async function onFormSubmit(e) {
		e.preventDefault()
		try {
			axios.put(`https://task.mycrmdesk.com/backend/api/admin/update-project/${userId}`, departments)
			.then((res) => {
