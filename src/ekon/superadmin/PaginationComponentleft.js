...
class PaginationComponentleft extends Component {
  constructor(props) {
    super(props);
    this.state = {
      totalRecords: 0,
  ...
  render() {
    ...
    return (
      <div className="pagination-wrapper" style={{ marginLeft: "10%" }}>
        <Pagination
...
PaginationComponentleft.propTypes = {
...
export default PaginationComponentleft;
