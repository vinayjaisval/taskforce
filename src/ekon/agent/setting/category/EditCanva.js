...
const EditCanva = (props) => {
	...
	async function getCategorys() {
		try {
			const categorysApi = await axios.get(`https://task.mycrmdesk.com/backend/api/admin/edit-category/${userId}`)
	...
	async function onFormSubmit(e) {
		e.preventDefault()
		try {
			axios.put(`https://task.mycrmdesk.com/backend/api/admin/update-category/${userId}`, categorys)
			.then((res) => {
