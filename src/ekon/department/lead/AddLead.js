...
const AddLead = () => {
	...
	async function onFormSubmit(e) {
		...
		if(lead.name == ''){
			...
			try {
			axios.post(`https://task.mycrmdesk.com/backend/api/department/add-lead/${id}`, lead)
			.then((res) => {
								...
								<form className='row g-4' id='leadForm'>
									...
									<div className='col-md-4 col-xs-12'>
										<FormGroup
											...
											isFloating
											label='Type'>
											<select className="form-control" name="type" id="type" onChange={e => onTextFieldChange(e)} required>
									...
									<div className='col-md-4 col-xs-12'>
										<FormGroup
											...
											isFloating
											label='Source'>
											<select className="form-control" name="source" id="source" onChange={e => onTextFieldChange(e)}>
